...
export const Sidebar = () => {
  return (
    <>
      ...
      {/* full sidebar */}
      {/* <!-- Component Start --> */}
      <div className="hidden lg:flex flex-col items-center w-60 h-full overflow-hidden text-indigo-300 bg-indigo-900">
        <a className="flex items-center w-full px-3 mt-3" href="#">
          ...
          <span className="ml-2 text-sm font-bold">Sleep Tracker</span>
        </a>
